    ...
    <main className="max-w-2xl mx-auto p-4">
      ...
      <ul className="space-y-4">
        {mockHashtags.map((hashtag) => (
          <li key={hashtag.id} className="bg-white rounded-lg shadow p-4 hover:bg-blue-50 transition">
            <a href={`/hashtag/${hashtag.id}`} className="text-xl font-semibold text-blue-700 hover:underline">
              {hashtag.name}
            </a>
